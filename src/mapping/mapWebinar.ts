...
export namespace MapWebinar {
    ...
    export function inWebinarControllersGetAllAsync(webinar: Webinar): Webinar {
        ...
        return {
            id, cpdPoints, status, topic, description, urlToken, startDateTime,
    ...
    export function inWebinarControllersGetByUrlTokenAsync(webinar: Webinar): Webinar {
        const { id, anchor, cpdPoints, topic, description, urlToken, transcript, startDateTime, status, comments } = webinar;
        return {
            id, cpdPoints, topic, description, urlToken, startDateTime, status,
            anchor: MapUser.inAllControllers(anchor),
